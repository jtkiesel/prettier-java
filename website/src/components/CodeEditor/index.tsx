...
const blueDecoration = Decoration.mark({ class: "cm-blue" });
const redDecoration = Decoration.mark({ class: "cm-red" });
const yellowDecoration = Decoration.mark({ class: "cm-yellow" });
...
function createRulerTheme(printWidth?: number, color?: string) {
  if (!printWidth) {
