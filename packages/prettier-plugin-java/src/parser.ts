...
import type { JavaComment, JavaNode } from "./printers/helpers.js";
import { SyntaxType, type SyntaxNode } from "./tree-sitter-java.js";
...
export default {
  async parse(text) {
    ...
    const ast = processTree(tree.rootNode as unknown as SyntaxNode);
