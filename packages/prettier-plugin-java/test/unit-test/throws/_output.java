public abstract class Throws {
  ...
  void throwException3(String string1,
  String string2,
  String string3) throws RuntimeException {
    throw new RuntimeException();
  }
  ...
  void throwException6(String string1,
  String string2,
  String string3) throws RuntimeException, RuntimeException, RuntimeException {
    throw new RuntimeException();
  }

  void throwException7(String string1,
  String string2,
  String string3,
  String string4) throws RuntimeException {
    throw new RuntimeException();
  }

  void throwException8(String string1,
  String string2,
  String string3,
  String string4) throws RuntimeException, RuntimeException, RuntimeException {
    throw new RuntimeException();
  }

  void throwException9(String string1,
  String string2,
  String string3,
  String string4)
  ...
  abstract void absThrowException3(String string1,
  String string2,
  String string3) throws RuntimeException;
  ...
  abstract void absThrowException6(String string1,
  String string2,
  String string3) throws RuntimeException, RuntimeException, RuntimeException;

  abstract void absThrowException7(String string1,
  String string2,
  String string3,
  String string4) throws RuntimeException, RuntimeException, RuntimeException;

  abstract void absThrowException8(String string1,
  String string2,
  String string3,
  String string4)
    throws RuntimeException, RuntimeException, RuntimeException, RuntimeException;
  ...
  String string3,
  String string4,
  String string5) throws RuntimeException {
    System.out.println("Constructor with throws that should wrap");
  }
